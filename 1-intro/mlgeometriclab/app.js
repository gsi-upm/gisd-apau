...
function setLegend(){const legend=$('.legend');if(!legend)return;const en=window.LabLanguage?.value==='en',noiseKey=en?' <span class="noise-ring" title="Modified label in training"></span> modified label in training':' <span class="noise-ring" title="Etiqueta modificada en entrenamiento"></span> etiqueta modificada en entrenamiento';legend.innerHTML=model==='kmeans'?(en?'Colors = k-Means clusters':'Colores = grupos de k-Means')+noiseKey:'<span class="dot a" title="'+(en?'Class 0 · training':'Clase 0 · entrenamiento')+'"></span><span class="dot a faded" style="opacity:.42" title="'+(en?'Class 0 · test':'Clase 0 · prueba')+'"></span> '+(en?'class 0 (negative)':'clase 0 (negativa)')+' <span class="dot b" title="'+(en?'Class 1 · training':'Clase 1 · entrenamiento')+'"></span><span class="dot b faded" style="opacity:.42" title="'+(en?'Class 1 · test':'Clase 1 · prueba')+'"></span> '+(en?'class 1 (positive)':'clase 1 (positiva)')+noiseKey}
