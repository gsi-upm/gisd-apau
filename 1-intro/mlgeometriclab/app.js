...
function setLegend(){const legend=$('.legend');if(!legend)return;const noiseKey=labelNoise>0&&showLabelErrors?' <span class="noise-ring"></span> etiqueta modificada':'';legend.innerHTML=model==='kmeans'?'Colores = grupos de k-Means'+noiseKey:'<span class="dot a"></span> clase 0 <span class="dot b"></span> clase 1'+noiseKey}
